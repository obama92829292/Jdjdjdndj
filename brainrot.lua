<meta name='viewport' content='width=device-width, initial-scale=1'/>-- Moonsec V3 compatible Roblox GUI script
...
local function createButton(parent, text, posY, callback)
    ...
    if callback then
        btn.MouseButton1Click:Connect(function()
            pcall(callback) -- Wrap callback in pcall for Moonsec safety
        end)
    end
...
createButton(tabFrames.Main, "Anti Ragdoll", 210, function()
    pcall(function()
        local success, result = pcall(function()
            return game:HttpGet("https://raw.githubusercontent.com/onliengamerop/Steal-gui/refs/heads/main/notficationantiragdoll.txt")
        end)
        if success then
            ...
            warn("Failed to load Anti Ragdoll script: " .. tostring(result))
        end
    end)
end)
...
local function buySpeedCoil()
    ...
    pcall(function()
        ...
        BuyFunction:InvokeServer("Speed Coil")
    end)
end
...
-- Instant Steal
createButton(tabFrames.Main, "Instant Steal", 310, function()
    pcall(function()
        local success, result = pcall(function()
            return game:HttpGet("https://raw.githubusercontent.com/onliengamerop/Steal-gui/refs/heads/main/instantstealbyajjan.lua.txt")
        end)
        if success then
            local func = loadstring(result)
            if func then
            ...
            warn("Failed to load Instant Steal script: " .. tostring(result))
        end
    end)
end)
...
createButton(tabFrames.Main, "Anti Trap", 360, function()
    pcall(function()
        local success, result = pcall(function()
            return game:HttpGet("https://raw.githubusercontent.com/onliengamerop/Steal-gui/refs/heads/main/antitrap.lua.txt")
        end)
        if success then
            local func = loadstring(result)
            if func then
            ...
            warn("Failed to load Anti Trap script: " .. tostring(result))
        end
    end)
end)
...
createButton(tabFrames.Main, "Anti Steal", 410, function()
    pcall(function()
        local success, result = pcall(function()
            return game:HttpGet("https://raw.githubusercontent.com/onliengamerop/Steal-gui/refs/heads/main/antisteal.txt")
        end)
        if success then
            local func = loadstring(result)
            if func then
            ...
            warn("Failed to load Anti Steal script: " .. tostring(result))
        end
    end)
end)
...
createButton(tabFrames.Visual, "ESP", 60, function()
    pcall(function()
        local success, result = pcall(function()
            return game:HttpGet("https://raw.githubusercontent.com/onliengamerop/Steal-gui/refs/heads/main/esp1.txt")
        end)
        if success then
            local func = loadstring(result)
            if func then
            ...
            warn("Failed to load ESP script: " .. tostring(result))
        end
    end)
end)
...
createButton(tabFrames.Visual, "Brainrot ESP", 110, function()
    pcall(function()
        local success, result = pcall(function()
            return game:HttpGet("https://pastebin.com/raw/HbJFXm31")
        end)
        if success then
            local func = loadstring(result)
            if func then
            ...
            warn("Failed to load Brainrot ESP script: " .. tostring(result))
        end
    end)
end)
...
createButton(tabFrames.Misc, "ServerHop", 10, function()
    pcall(function()
        local success, result = pcall(function()
            return game:HttpGet("https://raw.githubusercontent.com/Youifpg/Steal-a-Brianrot/refs/heads/main/Secrets%20finder.lua")
        end)
        if success then
            local func = loadstring(result)
            if func then
            ...
            warn("Failed to load ServerHop script: " .. tostring(result))
        end
    end)
end)
...
createButton(tabFrames.Misc, "Anti Kick", 60, function()
    pcall(function()
        local success, result = pcall(function()
            return game:HttpGet("https://pastefy.app/dAjYZBnq/raw")
        end)
        if success then
            local func = loadstring(result)
            if func then
            ...
            warn("Failed to load Anti Kick script: " .. tostring(result))
        end
    end)
end)
...
createButton(tabFrames.Misc, "Check Server Version", 110, function()
    pcall(function()
        local success, result = pcall(function()
            return game:HttpGet("https://raw.githubusercontent.com/onliengamerop/Steal-gui/refs/heads/main/serverversion.txt")
        end)
        if success then
            local func = loadstring(result)
            if func then
            ...
            warn("Failed to load Server Version script: " .. tostring(result))
        end
    end)
end)
...
openButton.MouseButton1Click:Connect(function()
    pcall(function() toggleGUI(true) end)
end)

closeButton.MouseButton1Click:Connect(function()
    pcall(function() toggleGUI(false) end)
end)